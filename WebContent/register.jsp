...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="login" placeholder="Insert your Login" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="first_name" placeholder="Insert your First Name" class="form-control input-md" required="" type="text">
  <span class="help-block"> </span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="last_name" placeholder="Insert your Last Name" class="form-control input-md" required="" type="text">
  <span class="help-block"> </span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="nickname" placeholder="Insert your nickname" class="form-control input-md" required="" type="text">
  <span class="help-block"> </span>  
  </div>
</div>
