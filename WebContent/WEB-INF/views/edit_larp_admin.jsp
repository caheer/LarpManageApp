...
<div class="container">
	<div class="row">
		<h2>Edit Larp Data</h2> 
        
<form class="form-horizontal"  method="POST" action="EditLarp">
<fieldset>

<!-- Form Name -->
<legend>Change larp details here</legend>
...
<label class="col-md-4 control-label" for="registr_status">Registration Status</label>  
  ...
  <div class="styled-select">
		<select name="registr_status" class="dropdown" data-settings='{"wrapperClass":"metro"}'>
		<c:if test = "${chosen_larp.larp_reg_stat == 'Registration_active' }">
		...
		<c:if test = "${chosen_larp.larp_reg_stat == 'Registration_disabled' }">
			<option value="Registration_active">Registration_active</option>
			<option value="Registration_disabled" selected>Registration_disabled</option>
			<option value="Registration_ended">Registration_ended</option> 
			</c:if>
		<c:if test = "${chosen_larp.larp_reg_stat == 'Registration_ended' }">
			<option value="Registration_active">Registration_active</option>
			<option value="Registration_disabled">Registration_disabled</option>
			<option value="Registration_ended" selected>Registration_ended</option> 
			</c:if>
		</select>
		</div>
		  <span class="help-block"> </span>  
...
<div class="form-group">
              <label  class="col-md-4 control-label" for="datepicker">Date</label>
               <div class="col-md-4">
                <input type="text" name="selDate" id="datepicker" value="${date_in_form}" required="" readonly>
                  <span class="help-block"> </span>  
 				 </div>
                </div>
