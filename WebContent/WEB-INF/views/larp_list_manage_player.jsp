...
<title>LARP LIST - Manage Registrations</title>
...
<br>
<h2 style="text-decoration: underline;">Larp List - Manage Registrations</h2>

 <form method="POST" action="RemoveLoggedUserFromLarp"> 
...
<button id="submitbutton" type="submit" class="myButton">Remove your registration</button> <br> <br>
 </form>
