...
<title>Larp List - Edit and Remove</title>
...
<br>
<h2 style="text-decoration: underline;">Larp List - Edit and Remove</h2>

 <form method="POST" action="RemoveLarp"> 
...
<button id="submitbutton" type="submit" class="myButton" onclick="RemoveLarp">Remove Larp</button>
 <button id="submitbutton_b" type="submit" class="myButton" formaction="EditLarpForm" value="${record.id}">Edit Larp</button>
 </form>
