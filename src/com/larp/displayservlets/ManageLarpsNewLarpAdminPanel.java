...
/**
 * Servlet implementation class ManageLarpsNewLarpAdminPanel
 */
@WebServlet("/ManageLarpsNewLarpAdminPanel")
public class ManageLarpsNewLarpAdminPanel extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ManageLarpsNewLarpAdminPanel() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ((lv.isAdmin(session, userstatus)) == false) {
			...
			view = request.getRequestDispatcher("WEB-INF/views/add_new_larp_admin.jsp");
		}
