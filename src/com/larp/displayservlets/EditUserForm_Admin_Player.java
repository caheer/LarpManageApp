 ...
 */
@WebServlet("/EditUserForm_Admin_Player")
public class EditUserForm_Admin_Player extends HttpServlet {
	 ...
	 */
	public EditUserForm_Admin_Player() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (userstatus.equals("Admin")) {
			view = request.getRequestDispatcher("WEB-INF/views/edit_user_admin.jsp");
		} else {
			view = request.getRequestDispatcher("WEB-INF/views/edit_user_player.jsp");
		}
