...
/**
 * Servlet implementation class ManageLarpsListAdmin
 */
@WebServlet("/ManageLarpsListAdminPanel")
public class ManageLarpsListAdminPanel extends HttpServlet {
	 ...
	 */
	public ManageLarpsListAdminPanel() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ((lv.isAdmin(session, userstatus)) == false) {
			...
			List<Larp> lList = (List<Larp>) ls.getLarps();
			request.setAttribute("larp_list", lList);
			view = request.getRequestDispatcher("WEB-INF/views/manage_larplist_admin.jsp");
		}
