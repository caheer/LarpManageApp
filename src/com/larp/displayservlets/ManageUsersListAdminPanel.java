...
/**
 * Servlet implementation class ManageUsersListAdminPanel
 */
@WebServlet("/ManageUsersListAdminPanel")
public class ManageUsersListAdminPanel extends HttpServlet {
	 ...
	 */
	public ManageUsersListAdminPanel() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ((lv.isAdmin(session, userstatus)) == false) {
			...
			view = request.getRequestDispatcher("WEB-INF/views/manage_users_admin.jsp");
		}
